...
export const createWeexRecord = function(param = {}) {
  ...
  return new Promise((resolve,reject) => {
    cmlBridge.createWeexRecord(param,function(res){
 ...
 * @param:{id:1}
 */
  cmlBridge.startWeexRecord(param,function(res){
...
export const stopWeexRecord = function(param,cb = () => {}) {
  /**
 * @param:{id:1}
 */
  cmlBridge.stopWeexRecord(param,function(res){
    let {errno,msg} = res;//data:{id:1} 
    if(errno == 0){
      cb(res)
    }
